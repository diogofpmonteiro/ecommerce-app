...
export interface Tenant {
  id: string;
  /**
   * This is the name of the store (e.g. Diogo's Store)
   */
  name: string;
  /**
   * This is the subdomain for the store (e.g. [slug].ecomm-app.com)
   */
  slug: string;
...
export interface Product {
  ...
  /**
   * If checked, the product will not be visible to customers (archived)
   */
  isArchived?: boolean | null;
  /**
   * If checked, the product will not be visible to customers (private)
   */
