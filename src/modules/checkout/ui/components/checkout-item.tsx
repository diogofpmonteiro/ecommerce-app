...
export const CheckoutItem = ({ isLast, imageUrl, name, productUrl, tenantName, tenantUrl, price, onRemove }: Props) => {
  return (
    <div className={cn("grid grid-cols-[8.5rem_1fr_auto] gap-4 pr-4 border-b", isLast && "border-b-0")}>
      ...
      <div className='py-4 flex flex-col justify-between'>
        ...
        <button type='button' onClick={onRemove} className='underline font-medium cursor-pointer'>
          Remove
        </button>
      </div>
    </div>
